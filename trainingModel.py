...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data_getter=data_loader.Data_Getter(self.log_writer)
            ...
            kmeans=clustering.KMeansClustering(self.log_writer) # object initialization.
            ...
            for i in list_of_clusters:
                ...
                model_finder=tuner.Model_Finder(self.log_writer) # object initialization

                #getting the best model for each of the clusters
                best_model_name,best_model=model_finder.get_best_model(x_train,y_train,x_test,y_test)

                #saving the best model to the directory.
                file_op = file_methods.File_Operation(self.log_writer)
            ...
            self.log_writer.log( 'Unsuccessful End of Training')
            raise Exception