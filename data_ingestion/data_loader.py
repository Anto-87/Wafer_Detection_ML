...
class Data_Getter:
    ...
    def get_data(self):
        ...
        try:
            collection  = self.connection.getCollection(self.config.getMongoDBProperty('TRAINING_GOOD_RAW_DATA'))
            ...
            self.logger_object.log('Exception occured in get_data method of the Data_Getter class. Exception message: '+str(e))
